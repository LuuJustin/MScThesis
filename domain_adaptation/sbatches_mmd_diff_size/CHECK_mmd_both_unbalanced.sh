...
srun python /home/nfs/jluu/domain_adaptation/main.py --type mmd --source_dataset check --filename check_mmd_both_unbalanced_diff_size --epochs 50 --batch_size 32 --lr 0.00025 --source_majority_class=0 --target_majority_class=0 --source_ratio 0.7 --target_ratio 0.7 --same_size 0
