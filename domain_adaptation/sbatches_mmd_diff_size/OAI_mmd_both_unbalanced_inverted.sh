...
#SBATCH --time=01:10:00 # Request run time (wall-clock). Default is 1 minute
...
#SBATCH --mem=60G # Request memory (MB) per node. Default is 1024MB (1GB). For multiple tasks, specify --mem-per-cpu in$
...
srun python /home/nfs/jluu/model_code/main.py --type mmd --source_dataset oai --filename OAI_mmd_both_unbalanced_inverted --epochs 60 --batch_size 32 --lr 0.000005 --source_ratio 0.7 --target_ratio 0.7 --source_majority_class 1 --target_majority_class 0 --labda 10.0
