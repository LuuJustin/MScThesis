...
#SBATCH --mem=30G # Request memory (MB) per node. Default is 1024MB (1GB). For multiple tasks, specify --mem-per-cpu in$
...
srun python /home/nfs/jluu/domain_adaptation/main.py --type mmd --source_dataset check --filename check_mmd_both_unbalanced_inverted --epochs 50 --batch_size 32 --lr 0.00025 --source_majority_class=0 --target_majority_class=1 --source_ratio 0.7 --target_ratio 0.7
