...
#SBATCH --time=00:20:00 # Request run time (wall-clock). Default is 1 minute
...
srun python /home/nfs/jluu/model_code/main.py --type base --source_dataset check --filename CHECK_base_both_balanced --epochs 60 --batch_size 32 --lr 0.000005 --source_ratio 0.5 --target_ratio 0.5 --labda 0.0
