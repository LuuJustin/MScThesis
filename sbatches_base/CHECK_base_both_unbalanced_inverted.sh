...
srun python /home/nfs/jluu/model_code/main.py --type base --source_dataset check --filename CHECK_base_both_unbalanced_inverted --epochs 60 --batch_size 32 --lr 0.000005 --source_ratio 0.9 --target_ratio 0.9 --source_majority_class 0 --target_majority_class 1 --labda 0.0
