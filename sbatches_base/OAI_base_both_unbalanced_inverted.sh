...
srun python /home/nfs/jluu/model_code/main.py --type base --source_dataset oai --filename OAI_base_both_unbalanced_inverted --epochs 60 --batch_size 32 --lr 0.000005 --source_ratio 0.7 --target_ratio 0.7 --source_majority_class 1 --target_majority_class 0 --labda 0.0
