...
srun python /home/nfs/jluu/model_code/main.py --type base --source_dataset check --filename CHECK_base_us_bt --epochs 60 --batch_size 32 --lr 0.000005 --source_ratio 0.9 --target_ratio 0.5 --labda 0.0
