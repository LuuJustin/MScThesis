...
srun python /home/nfs/jluu/model_code/main.py --type base --source_dataset oai --filename OAI_base_both_unbalanced --epochs 60 --batch_size 32 --lr 0.000005 --source_ratio 0.7 --target_ratio 0.7 --labda 0.0
