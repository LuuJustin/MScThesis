...
srun python /home/nfs/jluu/model_code/main.py --type mmd --source_dataset oai --filename OAI_mmd_fulldataset --epochs 60 --batch_size 32 --lr 0.000005 --source_ratio 0.9 --target_ratio 0.5 --labda 10.0 --rebalance False
