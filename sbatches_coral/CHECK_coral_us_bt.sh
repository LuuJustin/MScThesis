...
srun python /home/nfs/jluu/model_code/main.py --type mmd --source_dataset check --filename CHECK_coral_us_bt --epochs 70 --batch_size 32 --lr 0.000005 --source_ratio 0.9 --target_ratio 0.5 --labda 20.0 --use_coral True
